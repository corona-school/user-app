...
app.get('/config.js', (req, res) => {
    const runtimeEnvironment = Object.fromEntries(Object.entries(process.env).filter(([key]) => key.startsWith('RUNTIME_')));
...
app.listen(process.env.PORT ?? 3000, () => console.info(`Express started and listening`));
