const course = {
  blocker: {
    ...
    firstContent: 'Du benötigts individuelle Unterstützung? Dann ist die 1:1 Lernunterstützung genau richtig. Hier kannst du eine:n neue:n Student:in anfordern, die dich beim Lernen unterstützt.',
    here: 'hier',
    secContent: 'Mehr Informationen zur Gruppennachhilfe findest du',
    thrContent: 'auf unserer Webseite.',
    contentHeadline: 'Wichtig',
    content: 'Aktuell bist du für die Gruppenkurse noch nicht freigeschaltet, aber scrolle hier durch die nächsten Prozessschritte, um herauszufinden, wie du das änderst:',
    cta: {
