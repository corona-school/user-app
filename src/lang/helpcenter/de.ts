const helpcenter = {
  ...
  assistance: {
    ...
    card0: {
      title: 'Quickstart',
      content: 'Alles, was du für den Anfang brauchst.',
      contentsContent: 'Kennenlerngespräch • Ethik • Lehrpläne • PDF',
      url: '/quick-start'
    },
    card1: {
      title: 'Pädagogik',
      content: 'Wissen, wie du unterrichtest.',
      contentsContent: 'Motivation • Lernatmosphäre • Feedback  • PDF',
      url: '/quick-start'
    },
    card2: {
    ...
    card5: {
      ...
      content: 'Sonstige Hilfe für dich oder deine:n Schüler:in.',
      contentsContent: 'Beratungsstelle • Angebotserweiterung • Sonstiges',
      url: '/quick-start'
    }
  },
  contact: {
