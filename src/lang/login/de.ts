const login = {
    ...
    passwordReset: {
        ...
        alert: {
            ...
            mailNotFound:
                'Für diese E-Mailadresse ist kein Account registriert. Wenn du denkst, dass das ein Fehler ist, melde dich bitte beim Support (support@lern-fair.de).',
        },
    },
    accountNotFound: {
        title: 'Anmeldung fehlgeschlagen',
        alert_html:
            'Es konnte kein Account mit der E-Mail Adresse <b>{{email}}</b> gefunden werden. Bitte kontrolliere die eingegebene E-Mailadresse und versuche es erneut.',
    },
};
