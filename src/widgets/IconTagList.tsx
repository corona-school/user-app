...
const IconTagList: React.FC<IIconTagList> = ({ iconPath, textIcon, text, link, variant = 'normal', space, onPress, isDisabled, initial }) => {
    ...
    return (
        <View height={variant === 'selection' ? '100%' : undefined} width={variant === 'full' || variant === 'selection' ? '100%' : ''} paddingY={space}>
            <Link
                    ...
                    >
                        ...
                        <Column alignItems="center" justifyContent="center">
                            <Text
                                ...
                                textAlign={variant === 'center' || variant === 'selection' ? 'center' : 'left'}
