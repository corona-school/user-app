...
const HelperWizard: React.FC<Props> = ({ index }) => {
    ...
    const onboardingIndex: number = useMemo(() => {
        if (data?.me?.student?.canCreateCourse.reason === 'not-screened' || data?.me?.student?.canRequestMatch.reason === 'not-screened') return 0;
                                ...
                                content: [
                                    {
                                        ...
                                        text: (
                                            <Box flexDir={ButtonDirection} alignItems={ContentsDirection} width="100%" justifyContent="space-between">
                                                <Text width={ZeugnisContentSectionWidth} display="block" marginBottom={ContentsSpace}>
                                                    {t('helperwizard.kennenlernen.content')}
                                                </Text>
                                                <Button
                                                    onPress={() => window.open(process.env.REACT_APP_SCREENING_URL)}
                                ...
                                content: [
                                    {
                                        ...
                                        text: (
                                            <Box width="100%">
                                                <Box flexDirection="row" marginBottom={space['0.5']} display="block" maxWidth="500px">
                                                    <Text marginRight="5px">{t('helperwizard.zeugnis.einreichen')}</Text>
                                                ...
                                                <Box flexDir={ButtonDirection} alignItems={ContentsDirection} width="100%" justifyContent="space-between">
                                                    <Column width={ZeugnisContentSectionWidth}>
                                                        <Text marginBottom={ContentsSpace}>{t('helperwizard.zeugnis.content')}</Text>
                                                    </Column>
                                                    <Column width={ButtonWidthContainer}>
                                                        <Button overflow="visible" width={ButtonContainer} marginRight={ButtonSpace}>
                                ...
                                content: [
                                    {
                                        ...
                                        text: (
                                            <Box width="100%">
                                                <Box flexDir={ButtonDirection} alignItems={ContentsDirection} width="100%" justifyContent="space-between">
                                                    <Column width={ZeugnisContentSectionWidth}>
                                                        <Text marginBottom={ContentsSpace}>{t('helperwizard.angebot.content')}</Text>
                                                    </Column>
                                                    <Column width={ButtonWidthContainer}>
                                                        <Button onPress={() => navigate('/matching')} width={ButtonContainer} marginRight={ButtonSpace}>
                                ...
                                content: [
                                    {
                                        ...
                                        text: (
                                            <Box width="100%">
                                                <Box flexDir={ButtonDirection} alignItems={ContentsDirection} width="100%" justifyContent="space-between">
                                                    <Column width={ZeugnisContentSectionWidth}>
                                                        <Text marginBottom={ContentsSpace}>{t('helperwizard.zeugnisHochladen.content')}</Text>
                                                    </Column>
                                                    <Column width={ButtonWidthContainer}>
                                                        <Button width={ButtonContainer} marginRight={ButtonSpace}>
