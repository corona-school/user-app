...
const CustomVideoInput: React.FC<CustomVideoInputProps> = ({ inputValue, handleBlur, handleInput, clearInput }) => {
    ...
    return (
        <Stack space={1}>
            <FormControl>
                <CustomSelect placeholder="Videochat" onValueChange={handleValueChange}>
