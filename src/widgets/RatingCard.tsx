...
const RatingCard: React.FC<Props> = ({ variant = 'normal', name, link, content, avatar }) => {
                ...
                <Card flexibleWidth={variant === 'horizontal' || variant === 'teaser' ? true : false}>
                    {variant === 'horizontal' || variant === 'teaser' ? (
                        ...
                        <>
                            ...
                            {content && (
                                <Row paddingTop={space['0.5']} paddingBottom={space['0.5']} paddingLeft={space['1']} paddingRight={space['1']}>
                                    <Text marginBottom={!isBigger ? space['0.5'] : ''} textAlign={isBigger ? 'center' : 'left'}>
                                        {content}
                                    </Text>
                                </Row>
                            )}
