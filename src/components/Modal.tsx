        ...
        <ModalPortal>
            ...
            >
                ...
                <DialogPrimitive.Close
                    className={cn(
                        'absolute right-3 top-3 rounded-full p-2 bg-gray-100 hover:bg-gray-200 text-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none',
                        classes?.closeIcon
                    )}
