...
const ContactSupportFormular: React.FC<FormularProps> = ({ onCloseModal }) => {
        ...
        <View paddingLeft={space['1.5']}>
            ...
            <FormControl maxWidth={ContentContainerWidth}>
                ...
                <Row flexDirection="column" paddingY={space['1.5']}>
                    <Checkbox value="dsgvo" isChecked={dsgvo} onChange={(val) => setDSGVO(val)}>
                        <Text>
                            ...
                            <Link onPress={() => (window.location.href = 'mailto:mentoring@lern-fair.de?subject=Kontakt%20Userbereich')}>
                ...
                <Row flexDirection="column" paddingY={space['0.5']}>
                    ...
                    <Button marginX="auto" width={buttonWidth} isDisabled={!dsgvo || message?.length < 5 || subject?.length < 5} onPress={sendContactMessage}>
