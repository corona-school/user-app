...
export const LectureFeedbackModal = ({ feedbackId, onOpenChange, isOpen, learningPartnerName }: StudentScreeningModalProps) => {
    ...
    return (
        <Modal onOpenChange={onOpenChange} isOpen={isOpen} size="sm">
            ...
            <div className="mb-4">
                <Typography className="mb-10">Das Feedback geht nur an Lern-Fair. Dein*e Lernpartner*in {learningPartnerName} kann es nicht sehen.</Typography>
            ...
            <div>
                ...
                {tags.includes('Sonstiges') && <Input placeholder="Dein Kommentar" errorMessageClassName="hidden" value={comment} onChangeText={setComment} />}
            </div>
            <ModalFooter mobileLayout="column">
                ...
                <Button
                    ...
                    disabled={!rating}
                    onClick={() => submitFeedback({ variables: { feedbackId, rating: rating!, tags } })}
                >
                    Feedback senden
                </Button>
            </ModalFooter>
