    ...
    return (
        <>
            <Container maxWidth={ContainerWidth} width="100%" marginX="auto" paddingX={space['1.5']} alignItems="stretch" marginBottom={space['0.5']}>
                <Heading marginBottom={space['1']}>{t('matching.blocker.title')}</Heading>
                <Image
                ...
                />
                <Text marginBottom={space['1']}>{t('matching.blocker.firstContent')}</Text>
                ...
                <Button width={ButtonWidth} marginBottom={space['1.5']} variant="outline">
                    {t('matching.blocker.button')}
                </Button>
            </Container>
            <Container maxWidth={ContainerWidth} width="100%" marginX="auto" paddingX={space['1.5']} marginBottom={space['1.5']}>
                <CTACard
                    width="100px"
                    variant="dark"
