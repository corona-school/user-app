import { Text, Heading, useTheme, VStack, Input, Link, useBreakpointValue, Flex, Column } from 'native-base';
...
const StudentGroupSupport: React.FC<Props> = () => {
    ...
    return (
        <WithNavigation headerTitle={t('matching.group.helper.support.header')} headerLeft={<NotificationAlert />}>
            <VStack paddingX={space['1']} marginX="auto" width={ContainerWidth}>
                <VStack space={space['1']}>
                    ...
                    <VStack paddingY={space['1']}>
                        <Input size="lg" placeholder={t('matching.group.helper.support.search')} />
                    </VStack>
                    <VStack space={space['1']}>
