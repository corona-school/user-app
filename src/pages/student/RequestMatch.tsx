        ...
        <>
            ...
            <Modal isOpen={showModal}>
                <Modal.Content>
                    ...
                    <Modal.Body>
                        <Heading fontSize="md">
                            Klassen {(selectedClasses[focusedSubject.name] && selectedClasses[focusedSubject.name].min) || 1} -{' '}
                            {(selectedClasses[focusedSubject.name] && selectedClasses[focusedSubject.name].max) || 13}
                        </Heading>
                        <Slider
                            animateTransitions
                            minimumValue={1}
