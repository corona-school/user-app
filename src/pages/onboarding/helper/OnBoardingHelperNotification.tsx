...
const OnBoardingHelperNotification: React.FC<Props> = () => {
  const { space } = useTheme()
  const { t } = useTranslation()
  const navigate = useNavigate()

  const [cancelModal, setCancelModal] = useState<boolean>(false)
  const img = require('../../../assets/images/onboarding/helper/All_Helfer_Matching_Benachrichtigung.png')
              ...
              <Container maxWidth="100%">
                <Box width="100%">
                  <View
                    ...
                    <Text color="lightText" textAlign="center" maxWidth="288px">
                      {t('onboardingList.Wizard.helper.notification.content')}
                    </Text>
                  </View>
                </Box>
                ...
                <Box width="100%" marginY={space['1']} alignItems="center">
                  <HStack
                    ...
                    <Column>
                      <Link
                        onPress={() => navigate('/onboarding-helper/finish')}
                        _text={{
                          color: 'primary.900',
                          fontWeight: 600
                        }}
...
export default OnBoardingHelperNotification
