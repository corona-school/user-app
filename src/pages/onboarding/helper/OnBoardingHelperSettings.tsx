...
const OnBoardingHelperSettings: React.FC<Props> = () => {
  const { space } = useTheme()
  const { t } = useTranslation()
  const navigate = useNavigate()

  const [cancelModal, setCancelModal] = useState<boolean>(false)
  const img = require('../../../assets/images/onboarding/helper/All_Helfer_Einstellungen.png')
  ...
  return (
    <>
      <View backgroundColor="primary.100" height="100%">
        <WithNavigation
          isSidebarMenu={false}
          headerTitle={t('onboardingList.Wizard.helper.settings.title')}
          headerContent={
            <>
                ...
                <Box width="100%">
                  <View
                    ...
                    <Text color="lightText" textAlign="center" maxWidth="288px">
                      {t('onboardingList.Wizard.helper.settings.content')}
                    </Text>
                  </View>
                </Box>
...
export default OnBoardingHelperSettings
