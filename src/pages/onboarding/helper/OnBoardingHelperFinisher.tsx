...
import { useTheme, Text, View, Container, Row, Column, Heading, Image, Button } from 'native-base';
...
const OnBoardingHelperFinisher: React.FC<Props> = () => {
    ...
    return (
        <Fragment>
            <View position="relative" backgroundColor="primary.400" height="100%" justifyContent="center">
                <Image alt="Lernfair" position="absolute" width="100%" height="100%" source={{ uri: require('../../../assets/images/globals/lf-bg.png') }} />
                <Container maxWidth="100%">
                    <Row flexDirection="column" width="100%" alignItems="center">
                        <Column padding={space['2']}>
                            ...
                            <Text textAlign="center" maxWidth="250px" marginBottom={space['1']}>
