...
const OnBoardingHelperSlides: React.FC<Props> = () => {
    ...
    return (
        <Container backgroundColor="primary.100" maxWidth="100%" overflowY="scroll" height="100%" alignItems="stretch">
            <View flex={1}>
                <ViewPager isOnboarding={true} onFinish={() => navigate('/onboarding/helper/finish')}>
                    {/* Matching */}
                    <OnboardingView
