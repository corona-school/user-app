...
const OnBoardingHelperAppointment: React.FC<Props> = () => {
  const { space } = useTheme()
  const { t } = useTranslation()
  const navigate = useNavigate()

  const [cancelModal, setCancelModal] = useState<boolean>(false)
  const img = require('../../../assets/images/onboarding/helper/All_Helfer_Termine.png')
  ...
  return (
    <>
      <View backgroundColor="primary.100" height="100%">
        <WithNavigation
          isSidebarMenu={false}
          headerTitle={t('onboardingList.Wizard.helper.appointment.title')}
          headerContent={
            <>
                ...
                <Box width="100%" marginBottom={space['2']}>
                  <View
                    ...
                    <Text color="lightText" textAlign="center" maxWidth="288px">
                      {t('onboardingList.Wizard.helper.appointment.content')}
                    </Text>
                  </View>
                </Box>
                ...
                <Box width="100%" marginY={space['1']} alignItems="center">
                  <HStack
                    ...
                    <Column>
                      <Link
                        onPress={() =>
                          navigate('/onboarding-helper/helpcenter')
                        }
                        _text={{
                          color: 'primary.900',
                          fontWeight: 600
...
export default OnBoardingHelperAppointment
