...
const OnBoardingHelperHelpCenter: React.FC<Props> = () => {
  const { space } = useTheme()
  const { t } = useTranslation()
  const navigate = useNavigate()

  const [cancelModal, setCancelModal] = useState<boolean>(false)
  const img = require('../../../assets/images/onboarding/helper/All_Helfer_Hilfe.png')

  return (
    <Fragment>
      <View backgroundColor="primary.100" height="100%">
        <WithNavigation
          headerTitle={t('onboardingList.Wizard.helper.helpCenter.title')}
          headerContent={
            <>
              <Container maxWidth="100%">
                <Box width="100%" marginBottom={space['2']}>
                  <View
                    ...
                    <Text color="lightText" textAlign="center" maxWidth="288px">
                      {t('onboardingList.Wizard.helper.helpCenter.content')}
                    </Text>
                  </View>
                </Box>
                ...
                <Box width="100%" marginY={space['1']} alignItems="center">
                  <HStack
                    ...
                    <Column>
                      <Link
                        onPress={() => navigate('/onboarding-helper/profil')}
                        _text={{
                          color: 'primary.900',
                          fontWeight: 600
                        }}
...
export default OnBoardingHelperHelpCenter
