...
const OnBoardingHelperMatchingSlides: React.FC<Props> = () => {
    ...
    return (
        <Container backgroundColor="primary.100" maxWidth="100%" height="100%" overflowY="scroll" alignItems="stretch">
            <View flex={1}>
                <ViewPager isOnboarding={true} onFinish={() => navigate('/onboarding/helpermatching/finish')}>
                    {/* Request Matching */}
                    <OnboardingView
                    ...
                    <OnboardingView
                        ...
                        contentEnd={t('onboardingList.Wizard.helperMatching.match.contentsec')}
                        image={imgMatch}
                        isBigger={true}
                    />
                    ...
                    <OnboardingView
                        ...
                        contentEnd={t('onboardingList.Wizard.helperMatching.contact.contentsec')}
                        image={imgContact}
                    />
                    ...
                    <OnboardingView
                        ...
                        content={t('onboardingList.Wizard.helperMatching.matchSolve.content')}
