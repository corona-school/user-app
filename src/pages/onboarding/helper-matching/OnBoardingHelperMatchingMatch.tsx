...
const OnBoardingHelperMatchingMatch: React.FC<Props> = () => {
  const { space } = useTheme()
  const { t } = useTranslation()
  const navigate = useNavigate()

  const [cancelModal, setCancelModal] = useState<boolean>(false)
  const img = require('../../../assets/images/onboarding/1-1-helper/1_1_Helfer_Matching.png')
...
export default OnBoardingHelperMatchingMatch
