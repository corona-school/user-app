...
const OnBoardingHelperMatchingContact: React.FC<Props> = () => {
  const { space } = useTheme()
  const { t } = useTranslation()
  const navigate = useNavigate()

  const [cancelModal, setCancelModal] = useState<boolean>(false)
  const img = require('../../../assets/images/onboarding/1-1-helper/1_1_Helfer_Kontaktaufnahme.png')

  return (
    <>
      <View backgroundColor="primary.100" height="100%">
        <WithNavigation
          headerTitle={t('onboardingList.Wizard.helperMatching.contact.title')}
          headerContent={
            <>
                ...
                <Box width="100%" marginBottom={space['2']}>
                  <View
                    ...
                    <Text
                      ...
                      {t(
                        'onboardingList.Wizard.helperMatching.contact.content'
                      )}
                    </Text>
...
export default OnBoardingHelperMatchingContact
