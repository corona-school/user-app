...
const OnBoardingStudentAppointments: React.FC<Props> = () => {
  const { space } = useTheme()
  const { t } = useTranslation()
  const navigate = useNavigate()

  const [cancelModal, setCancelModal] = useState<boolean>(false)
  const img = require('../../../assets/images/onboarding/student/All_Schueler_Termine.png')

  return (
    <>
      <View backgroundColor="primary.100" height="100%">
        <WithNavigation
          headerTitle={t('onboardingList.Wizard.students.appointments.title')}
          headerContent={
            <>
                ...
                <Box width="100%" marginBottom={space['2']}>
                  <View
                    ...
                    <Text color="lightText" textAlign="center" maxWidth="278px">
                      {t('onboardingList.Wizard.students.appointments.content')}
                    </Text>
                  </View>
                </Box>
...
export default OnBoardingStudentAppointments
