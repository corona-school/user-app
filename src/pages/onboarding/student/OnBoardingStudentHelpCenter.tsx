...
const OnBoardingStudentHelpCenter: React.FC<Props> = () => {
  const { space } = useTheme()
  const { t } = useTranslation()
  const navigate = useNavigate()

  const [cancelModal, setCancelModal] = useState<boolean>(false)
  const img = require('../../../assets/images/onboarding/student/All_Schueler_Hilfe.png')
  ...
  return (
    <>
      <View backgroundColor="primary.100" height="100%">
        <WithNavigation
          isSidebarMenu={false}
          headerTitle={t('onboardingList.Wizard.students.helpCenter.title')}
          headerContent={
            <>
                ...
                <Box width="100%">
                  <View
                    ...
                    <Text color="lightText" textAlign="center" maxWidth="278px">
                      {t('onboardingList.Wizard.students.helpCenter.content')}
                    </Text>
                  </View>
                </Box>
...
export default OnBoardingStudentHelpCenter
