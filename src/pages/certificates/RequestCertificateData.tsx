...
const RequestCertificateData: React.FC<Props> = ({ onNext, onBack, certificateType }) => {
    ...
    return (
        <VStack space={space['1']}>
            ...
            {(certificateType === 'matching' && <RequestCertificateMatchingWizard onNext={onNext} />) || <RequestCertificateGroupWizard onNext={onNext} />}
        </VStack>
    );
};
