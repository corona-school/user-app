...
const RequestCertificateMode: React.FC<Props> = ({ onAutomatic, onManual, onBack }) => {
    ...
    return (
        <VStack space={space['1.5']}>
            ...
            <VStack space={space['0.5']}>
                ...
                <Text>Alles fertig ausgefüllt? Dann kannst du die Daten jetzt abschicken:</Text>
                <Button onPress={onAutomatic}>Automatisch anfordern</Button>
            </VStack>
            <VStack space={space['0.5']}>
                <Text bold>Manuell erstellen</Text>
                <Text>Alternativ kannst du die Bescheinigung auch manuell herunterladen und an deine:n Schüler:in per E-Mail verschicken:</Text>
