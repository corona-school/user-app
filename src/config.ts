...
export const HOMEWORK_HELP_COURSE = window?.liveConfig.RUNTIME_HOMEWORK_HELP_COURSE ?? process.env.REACT_APP_HOMEWORK_HELP_COURSE;
export const TEST_STUDENT_ID = window?.liveConfig.RUNTIME_TEST_STUDENT_ID ?? process.env.REACT_APP_TEST_STUDENT_ID;
